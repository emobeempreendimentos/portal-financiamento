...
export default function DashboardPage() {
  ...
  const [bloqueio, setBloqueio] = useState<{ tipo: "cancelado" | "expirado"; motivo?: string | null; concluidoEm?: string } | null>(null);
  ...
  // Tela de bloqueio — processo cancelado ou acesso expirado
  if (bloqueio) {
    ...
    return (
      <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 flex flex-col items-center justify-center px-4">
        <div className="w-full max-w-md bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-8 text-center space-y-5 shadow-lg">
          {/* Ícone */}
