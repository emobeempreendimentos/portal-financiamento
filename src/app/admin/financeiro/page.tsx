      ...
      >
        ...
        <div className="flex flex-col sm:flex-row flex-wrap items-start sm:items-center gap-3 p-4 border-b border-zinc-100 dark:border-zinc-800">
          ...
          {(filtroTipo !== "todos" || filtroMes || filtroCategoria) && (
            <button
              onClick={() => { setFiltroTipo("todos"); setFiltroMes(""); setFiltroCategoria(""); }}
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16">
            ...
            <button
              onClick={abrirNovo}
              className="mt-4 text-xs text-green-600 dark:text-green-400 hover:underline font-medium"
            >
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-zinc-100 dark:border-zinc-800">
                  <th className="text-left px-5 py-3 text-xs font-semibold text-zinc-400 uppercase tracking-wide">Data</th>
                  <th className="text-left px-5 py-3 text-xs font-semibold text-zinc-400 uppercase tracking-wide">Descrição</th>
                  <th className="text-left px-5 py-3 text-xs font-semibold text-zinc-400 uppercase tracking-wide">Categoria</th>
                  <th className="text-left px-5 py-3 text-xs font-semibold text-zinc-400 uppercase tracking-wide">Tipo</th>
                  <th className="text-right px-5 py-3 text-xs font-semibold text-zinc-400 uppercase tracking-wide">Valor</th>
              ...
              <tbody className="divide-y divide-zinc-50 dark:divide-zinc-800">
                {lancamentos.map((l) => (
                  <tr key={l.id} className="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors">
                    ...
                    <td className="px-5 py-3.5 font-medium text-zinc-900 dark:text-white max-w-xs">
                      <div className="truncate">{l.descricao}</div>
                      {l.observacao && (
                        <div className="text-xs text-zinc-400 truncate mt-0.5">{l.observacao}</div>
                      )}
                    </td>
              ...
              {/* Rodapé com subtotal filtrado */}
              {lancamentos.length > 0 && (
                <tfoot>
                  <tr className="border-t-2 border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800/50">
                    <td colSpan={4} className="px-5 py-3 text-xs font-semibold text-zinc-500 uppercase tracking-wide">
                      Subtotal ({lancamentos.length} lançamentos)
                    </td>
                    <td className="px-5 py-3 text-right font-bold text-zinc-900 dark:text-white tabular-nums">
                      {(() => {
                        ...
                        const s = r - d;
                        return (
                          <span className={s >= 0 ? "text-green-600 dark:text-green-400" : "text-red-500 dark:text-red-400"}>
                            {fmt(s)}
                          </span>
                        );
                      })()}
        ...
        {modalOpen && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-md bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl border border-zinc-200 dark:border-zinc-800"
            >
              {/* Header */}
              ...
              {/* Footer */}
              <div className="flex gap-2 px-6 py-4 border-t border-zinc-100 dark:border-zinc-800">
                <button
                  onClick={fecharModal}
