...
export default function FinanceiroPessoalPage() {
  ...
  async function salvar() {
    ...
    try {
      const url = editando
        ? `/api/admin/financeiro-pessoal/${editando.id}`
      ...
      >
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16">
            ...
            <button
              onClick={abrirNovo}
              className="mt-4 text-xs text-violet-600 dark:text-violet-400 hover:underline font-medium"
            >
            ...
            >
              <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-100 dark:border-zinc-800">
                <h2 className="font-semibold text-zinc-900 dark:text-white">
                  {editando ? "Editar Lançamento" : "Novo Lançamento Pessoal"}
                </h2>
                <button
                  onClick={fecharModal}
