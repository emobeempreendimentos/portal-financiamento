  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="padding:40px 20px;">
    <tr><td align="center">
      <table width="100%" style="max-width:480px;background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #e4e4e7;">
        <tr><td style="background:#16181d;padding:28px 32px;">
          <p style="color:#c49e62;font-size:12px;font-weight:600;letter-spacing:.08em;text-transform:uppercase;margin:0 0 6px;">Portal de Financiamento</p>
        ...
        <tr><td style="padding:32px;">
          ...
          <a href="${resetUrl}"
             style="display:inline-block;background:#c49e62;color:#1d1406;font-size:14px;font-weight:600;
